 ...
 * @author joshy
 */
public class JXMapKit4 extends JPanel
{
	...
	public JXMapKit4()
	{
		...
		try
		{
			Icon minusIcon = new ImageIcon(JXMapKit4.class.getResource("/images/minus.png"));
			this.zoomOutButton.setIcon(minusIcon);
			this.zoomOutButton.setText("");
			Icon plusIcon = new ImageIcon(JXMapKit4.class.getResource("/images/plus.png"));
...
//				Point2D centerpos = map.getTileFactory().geoToPixel(mapCenterPosition, map.getZoom());
	...
	private void initComponents()
	{
		...
		zoomInButton.setIcon(new ImageIcon(JXMapKit4.class.getResource("/images/plus.png")));
		...
		zoomOutButton.setIcon(new ImageIcon(JXMapKit4.class.getResource("/images/minus.png")));
